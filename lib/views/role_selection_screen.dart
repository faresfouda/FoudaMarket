          ...
          child: Column(
            ...
            children: [
              ...
              _RoleCard(
                ...
                label: 'مدخل بيانات',
                color: Colors.blue,
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => DataEntryHomeScreen())),
              ),
              const SizedBox(height: 24),
              _RoleCard(
                ...
                label: 'مسؤول',
                color: Colors.green,
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => AdminDashboardMain())),
              ),
            ],
          ),
        ),
